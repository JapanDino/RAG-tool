    ...
    return (
        <section className={s.panel}>
            ...
            <p>
                ...
                поделиться. Записи не содержат имён, ID учеников и точного
                времени. Автоматическое удаление личных данных может ошибаться:
                узнаваемость по контексту сохраняется.
            </p>
            {error && (
