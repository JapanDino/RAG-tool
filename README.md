...
Документация пилота: [техническое описание](docs/TECHNICAL_GUIDE.md), [руководство ученика и преподавателя](docs/USER_GUIDE.md), [результаты проверки работающего приложения](docs/PILOT_VERIFICATION.md).
