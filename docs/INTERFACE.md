...
Обновление 20.09.2026: преподаватель проверяет чат по черновику в окне материала; в анализе Блума сохраняет отдельное экспертное решение; в «Готовности курса» видит обработку, публикацию и технический результат проверки ответа. Ученик продолжает тренировку из трёх вопросов после перезагрузки, с восстановлением черновика. Условия хранения и пошаговые действия: [руководство пользователя](USER_GUIDE.md).

Анализ Блума обновлён до контекстной рубрики: отдельные процессы и типы знания, цитата задания, правило, статус «Нужен контекст» и научные ссылки. [Методика и ограничения](BLOOM_METHODOLOGY.md).
